    ...
    return (
        <div className="w-[257px] h-full flex  flex-col  border-r-1 border-white/20 ">
            ...
            <div className="w-full border-b-1 border-b-white/20 flex flex-col justify-start gap-4 py-5  px-5">
                ...
                <Link href={"#"} className="text-white text-medium hover:text-light_blue-500 transition-all ease-linear">Companies</Link>
            </div>
            <div className="w-full border-b-1 border-b-white/20 flex flex-col justify-start gap-4 py-5  px-5">
                <h1 className="text-white/50 text-sm">Account</h1>
                <Link href={"#"} className="text-white text-medium hover:text-light_blue-500 transition-all ease-linear">Preferences</Link>
            ...
            <div className="w-full h-[50px] text-white hover:text-danger-500 gap-2 transition-all ease-linear cursor-pointer border-b-1 border-b-white/20 flex items-center   px-5">
                <LuLogOut />
