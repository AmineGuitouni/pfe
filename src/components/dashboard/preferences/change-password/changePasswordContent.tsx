...
export default async function ChangePasswordContent({ token }: { token: string | null }) {
    ...
    const states = {
      success: {
        ...
        message: "Your email has been successfully verified. You can now change your password.",
        action: (
