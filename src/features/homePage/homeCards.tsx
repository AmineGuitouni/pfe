...
export default function HomeCards() {
    const t = useTranslations('homepage.section1.features');
    ...
    return (
        <section id="features" className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 z-10 p-2 md:p-0"> {/* Use grid layout */}
            <div className="bg-white/10 hover:scale-105 min-h-[200px] transition-all ease-linear border-white/20 border-1 rounded-md p-5 w-full h-full flex flex-col gap-5"> {/* Remove lg:w-1/3 */}
                ...
                <h1 className="text-2xl font-semibold text-white">{t('aiTaskManagement.title')}</h1>
                <p className="text-white/70">{t('aiTaskManagement.description')}</p>
            ...
            <div className="bg-white/10 border-white/20 min-h-[200px] hover:scale-105 transition-all ease-linear border-1 rounded-md p-5 w-full h-full flex flex-col gap-5"> {/* Remove lg:w-1/3 */}
                ...
                <h1 className="text-2xl font-semibold text-white">{t('commandCenter.title')}</h1>
                <p className="text-white/70">{t('commandCenter.description')}</p>
                
            </div>

            <div className="bg-white/10 border-white/20 min-h-[200px] hover:scale-105 transition-all ease-linear border-1 rounded-md p-5 w-full h-full flex flex-col gap-5"> {/* Remove lg:w-1/3 */}
                <ImStatsDots className="text-3xl text-light_blue-500" />
                <h1 className="text-2xl font-semibold text-white">{t('smartAnalytics.title')}</h1>
                <p className="text-white/70">{t('smartAnalytics.description')}</p>
            ...
            <div className="bg-white/10 border-white/20 min-h-[200px] hover:scale-105 transition-all ease-linear border-1 rounded-md p-5 w-full h-full flex flex-col gap-5"> {/* Remove lg:w-1/3 */}
                ...
                <h1 className="text-2xl font-semibold text-white">{t('resourceHub.title')}</h1>
                <p className="text-white/70">{t('resourceHub.description')}</p>
            </div>

            {/* New Card: Streamlined HR */}
            <div className="bg-white/10 border-white/20 min-h-[200px] hover:scale-105 transition-all ease-linear border-1 rounded-md p-5 w-full h-full flex flex-col gap-5"> {/* Remove lg:w-1/3 */}
                <FaUserCog className="text-3xl text-light_blue-500" />
                <h1 className="text-2xl font-semibold text-white">{t('streamlinedHR.title')}</h1>
                <p className="text-white/70">{t('streamlinedHR.description')}</p>
            </div>

            {/* New Card: Project Visibility */}
            <div className="bg-white/10 border-white/20 min-h-[200px] hover:scale-105 transition-all ease-linear border-1 rounded-md p-5 w-full h-full flex flex-col gap-5"> {/* Remove lg:w-1/3 */}
                <FaTasks className="text-3xl text-light_blue-500" />
                <h1 className="text-2xl font-semibold text-white">{t('projectVisibility.title')}</h1>
                <p className="text-white/70">{t('projectVisibility.description')}</p>
            </div>
